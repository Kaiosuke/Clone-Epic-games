    ...
    div.innerHTML = `
        <div class="py-6 flex items-center justify-between">
              ...
              <ul class="flex items-center gap-x-5 group">
                ...
                <li class="block md:hidden">
                  ...
                  >
                    ...
                    >
                      <li class="py-2">
                        <a class="${checkPage("index") ? "text-white" : "text-[#929294]"}" href="/index.html">Discover</a>
                      </li>
                      <li class="py-2">
                        <a class="${checkPage("browse") ? "text-white" : "text-[#929294]"}" href="/src/views/pages/browse/browse.html">Browser</a>
                      </li>
                      <li class="py-2">
                        <a class="${checkPage("news") ? "text-white" : "text-[#929294]"}" href="/src/views/pages/news/news.html">News</a>
                      </li>
                    </ul>
                  </a>
                </li>
                <li class="hidden md:block">
                  <a class="hover-second ${checkPage("browse") ? "text-white" : "text-[#929294]"}" href="/src/views/pages/browse/browse.html">Browser</a>
                </li>
                <li class="hidden md:block">
                  <a
                    class="${checkPage("news") ? "text-white" : "text-[#929294]"} hover-second"
            ...
            <ul class="flex items-center gap-4">
              <li class="lg:block hidden">
                <a class="${checkPage("wishList") ? "text-white" : "text-[#929294]"}" href="/src/views/pages/wishList/wishList.html"> Wishlist </a>
              </li>
        ...
        : ""}
              ...
              <li class="lg:hidden block">
                <a class="${checkPage("wishList") ? "text-white" : "text-[#929294]"}" href="/src/views/pages/wishList/wishList.html">
